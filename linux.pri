...
#3)  ~/linuxdeployqt-continuous-x86_64.AppImage /media/ns/ZONA-A1/zool/build_linux/zool -qmldir=/media/ns/ZONA-A1/zool -qmake=/home/ns/Qt/5.15.2/gcc_64/bin/qmake -verbose=3
...
#cp -r ~/Qt/5.15.2/gcc_64/qml /media/ns/ZONA-A1/zool/build_linux
#cp -r ~/Qt/5.15.2/gcc_64/plugins /media/ns/ZONA-A1/zool/build_linux

#Make Unik AppImage (The AppImage version is maked automatically from ./build_linux/default.desktop file)
#5) ~/linuxdeployqt-continuous-x86_64.AppImage /media/ns/ZONA-A1/zool/build_linux/zool -qmldir=/media/ns/ZONA-A1/zool -qmake=/home/ns/Qt/5.15.2/gcc_64/bin/qmake -verbose=3 -bundle-non-qt-libs -no-plugins -appimage

message(linux.pri is loaded......)

DD1=$$replace(PWD, /zool,/zool/build_linux)
DESTDIR= $$DD1

EXTRA_BINFILES += $$PWD/*.js
EXTRA_BINFILES += $$PWD/*.qml
EXTRA_BINFILES += $$PWD/*.py
EXTRA_BINFILES += $$PWD/*.html
